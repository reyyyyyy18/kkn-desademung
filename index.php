        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between gap-10 px-6 relative z-10">
            <div class="Home-content max-w-xl bg-white/80 rounded-lg p-8 shadow-lg">
                ...
                <div class="flex gap-4">
                    <a href="https://www.tiktok.com/@pemdes.demung?_t=ZS-8xjZ94umTDu&_r=1" class="text-2xl text-gray-600 hover:text-green-600"><i class='bx bxl-tiktok'></i></a>
                    <a href="https://www.instagram.com/demung_creative?igsh=MTZtc2pjdDM0bHpnYQ==" class="text-2xl text-gray-600 hover:text-green-600"><i class='bx bxl-instagram'></i>
                    </a>
                </div>
            </div>
            <div class="flex items-center gap-3">
